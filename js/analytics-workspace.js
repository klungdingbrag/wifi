...
(function(){
  ...
  function styles(){
    ...
    const s=document.createElement('style');s.id=SID;s.textContent=`
      .analytics-workspace{display:grid;gap:16px;margin-top:18px}.analytics-grid{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:12px}.analytics-card{padding:17px;border:1px solid var(--border,#e3eaf1);border-radius:15px;background:var(--surface,#fff)}.analytics-card-kicker{font-size:10px;font-weight:800;letter-spacing:.07em;color:var(--muted,#718096)}.analytics-card-value{font-size:21px;font-weight:800;margin-top:6px;color:var(--text,#263548)}.analytics-card-note{font-size:11px;color:var(--muted,#718096);margin-top:5px}.analytics-card.warning .analytics-card-value{color:var(--warning,#b98b4f)}.analytics-card.success .analytics-card-value{color:var(--success,#58a98a)}.analytics-panels{display:grid;grid-template-columns:1.15fr .85fr;gap:16px}.analytics-panel{padding:18px;border:1px solid var(--border,#e3eaf1);border-radius:17px;background:var(--surface,#fff)}.analytics-panel-head{display:flex;justify-content:space-between;gap:12px;align-items:start;margin-bottom:14px}.analytics-panel-title{font-weight:800;font-size:15px}.analytics-panel-sub{font-size:11px;color:var(--muted,#718096);margin-top:3px}.analytics-bars{display:grid;gap:10px}.analytics-bar-row{display:grid;grid-template-columns:72px 1fr 88px;gap:9px;align-items:center;font-size:11px}.analytics-bar-track{height:8px;background:var(--bg-soft,#edf2f7);border-radius:99px;overflow:hidden}.analytics-bar-fill{height:100%;width:0;border-radius:inherit;background:linear-gradient(90deg,var(--primary,#587da5),var(--cyan,#17b8dc))}.analytics-bar-row strong{text-align:right;font-size:11px}.analytics-list{display:grid;gap:8px}.analytics-list-item{display:flex;justify-content:space-between;gap:10px;padding:10px 0;border-bottom:1px solid var(--border,#e3eaf1);font-size:12px}.analytics-list-item:last-child{border-bottom:0}.analytics-list-item span{color:var(--muted,#718096)}@media(max-width:900px){.analytics-grid{grid-template-columns:repeat(2,minmax(0,1fr))}.analytics-panels{grid-template-columns:1fr}}@media(max-width:520px){.analytics-grid{grid-template-columns:1fr}.analytics-bar-row{grid-template-columns:62px 1fr 74px}}
